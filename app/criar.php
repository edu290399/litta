...
<div class="container-fluid" >
    ...
    <div class="row mb-5" style="text-align:center">
        <div class="col-lg-4 col-12">
            <form method="POST" action="./temasEntrevista">
                <button class="btEstilo" name="usuario" value=" <?php echo $id?> " type="submit" style="padding-left: 10px; padding-right:10px;width:100px;margin-left:2px">Entrevista<img src="./public/open-iconic/svg/clipboard.svg" class="icon" alt="clipboard"></button>
            </form>    
        </div>

        <div class="col-lg-4 col-12">
            <form method="POST" action="./temasQuiz">
                <button class="btEstilo" name="usuario" value=" <?php echo $id?> " type="submit" style="padding-left: 10px; padding-right:10px;width:100px;margin-left:2px">Quiz<img src="./public/open-iconic/svg/image.svg" class="icon" alt="image"></button>
            </form>    
        </div>

        <div class="col-lg-4 col-12">
            <form method="POST" action="./temasCluster">
                <button class="btEstilo" name="usuario" value=" <?php echo $id?> " type="submit" style="padding-left: 10px; padding-right:10px;width:100px;margin-left:2px">Cluster<img src="./public/open-iconic/svg/folder.svg" class="icon" alt="folder"></button>
            </form>    
        </div>
    </div> 
