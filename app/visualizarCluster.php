...
<div class="container" >
    ...
    <h2 style="text-align:center">VISUALIZAR CLUSTER </h2>
    ...
    <div class="row mb-5">
        <form method="POST" action="./criar.php">
            <button class="btEstilo" type="submit"  style="padding-left: 10px; padding-right:10px;width:100px;margin-left:2px">Voltar</button>
        </form>
    </div>
