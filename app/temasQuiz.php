...
<div class="container-fluid" >
    ...
    <div class="row mb-5" style="text-align:center">
        ...
        <div class="col-lg-4 col-12">
            <div class="row mb-5">
                    <button class="btEstilo"  id="btnAdiciona" style="padding-left: 10px; padding-right:10px;width:100px;margin-left:2px" data-toggle="modal" data-target="#exampleModalCenter">Adicionar tema de Quiz<img src="./public/open-iconic/svg/plus.svg" class="icon" alt="plus"></button>
            </div>
    ...
    <?php
        ...
        if (mysqli_query($conn, $sql)) {
          while($row = mysqli_fetch_assoc($result)) { $id = $row["id"]; $nome = $row["nome"]?>
            ...
            <div class="col-md-5 col-lg-5 col-12">
                <form method="POST" action="./linkarTemaQuiz">
                    <button class="btEstilo"  id="btnAdiciona" style="padding-left: 10px; padding-right:10px;width:100px;margin-left:2px" data-toggle="modal" data-target="#exampleModalCenter">Adicionar Quiz<img src="./public/open-iconic/svg/plus.svg" class="icon" alt="plus"></button>
                </form> 
            </div> 
