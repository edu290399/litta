    ...
    <div class="row mb-5" style="text-align:center">
        ...
        <div class="col-lg-4 col-12">
            <form method="POST" action="./criarQuiz">
                <button class="btEstilo" name="idTema" value='1' type="submit" style="padding-left: 10px; padding-right:10px;width:100px;margin-left:2px">Ver Quiz<img src="./public/open-iconic/svg/eye.svg" class="icon" alt="eye"></button>
            </form>    
        </div>
