...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="./public/css/novoQuiz.css">
  <style>
...
<div class="container-fluid" >
    ...
    <h2 style="text-align:center">Novo Quiz</h2>

    <div class="container-fluid">

        <form method="POST" action="./dataBaseManager/novoQuiz.php">
