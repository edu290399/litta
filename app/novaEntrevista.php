...
<div class="container-fluid" >
    ...
    <h2 style="text-align:center">Nova Entrevista</h2>

    <div class="container-fluid">
        <form method="POST" action="./dataBaseManager/novaEntrevista.php">

            <div class="row">
                <label>Nome da Entrevista</label>
                <input class="form-control campoDefault" placeholder="Campo obrigatório" name="nome" required/>
            </div>
            <div class="row mb-5">
                <label>Descrição</label>
                <input type="text" class="form-control campoDefault" placeholder="Campo obrigatório" name="descricao" required/>
            </div>
            <div class="row">
                <label>Pergunta</label>
                <input class="form-control campoDefault" placeholder="Campo obrigatório" name="p1" required/>
            </div>
            ...
            <button class="btEstilo" type="submit" name='btnCadastra' style="padding-left: 10px; padding-right:10px;width:100px;margin-left:2px">Salvar Entrevista</button>
