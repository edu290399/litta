...
<div class="container-fluid" >
    ...
    <div class="row mb-5" style="text-align:center">
        <div class="col-lg-4 col-12">
            <div class="row mb-5">
                    <button class="btEstilo"  id="btnAdiciona" style="padding-left: 10px; padding-right:10px;width:100px;margin-left:2px">Adicionar tema de Entrevista<img src="./public/open-iconic/svg/plus.svg" class="icon" alt="plus"></button>
            </div>
        </div>
